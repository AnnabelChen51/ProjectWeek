...
4. [Deep Fiber Clustering: Anatomically Informed Unsupervised Deep Learning for Fast and Effective White Matter Parcellation](Projects/DeepFiberClustering/README.md) (Yuqian Chen, Chaoyi Zhang, Yang Song, Tengei Xue, Nikos Makris, Yogesh Rathi, Weidong Cai, Fan Zhang, Lauren J O'Donnell)
